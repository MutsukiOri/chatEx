                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        if (!GroupInfoScreen.isInEditMode)
                                          Text(
                                            groupAbout.isEmpty
                                                ? "Add group about to display here"
                                                : groupAbout,
                                            maxLines: 3,
                                            style: GoogleFonts.poppins(
                                                fontWeight: FontWeight.w400,
                                                              ...
                                                              IconButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (groupAbout !=
                                                                      ...
                                                                      showSnackBar(
                                                                          context,
                                                                          "Group about has been changed to,\n$groupAbout",
                                                                          2000,
                                                                          bgColor:
                                                                              Colors.indigo);
                                                                    } else {
                                          ...
                                          IconButton(
                                              ...
                                              onPressed: () {
                                                if (!isAdmin) {
                                                  ...
                                                  showSnackBar(
                                                      context,
                                                      "Group creator cannot leave group without deleting it.",
                                                      3000,
