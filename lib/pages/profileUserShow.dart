                              ...
                              children: [
                                ...
                                if (inEditMode) ...[
                                  ImagePickerCircleAvatar(
                                      userDpPath:
                                          dataPassed["userProfilePicturePath"])
                                ],
                                if (!isMe) ...[
                                  const SizedBox(
                                    height: 15,
                                  ...
                                  TextButton(
                                    onPressed: () async {
                                      if (updatedName != "" ||
                                        ...
                                        if (ImagePickerCircleAvatar.image !=
                                            null) {
